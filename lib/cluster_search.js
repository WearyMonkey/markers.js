(function() {
        ...
        for (var point1Id in connections) {
            ...
            for (var point2Id in p1Connections) {
                ...
                if (!ids[connection._id]) {
                    ...
                    connection._displayCluster1 = connection._cluster._pointToNode[connection._pointId1];
                    connection._displayCluster2 = connection._cluster._pointToNode[connection._pointId2];
    ...
    function getConnectionChild(zoom, displayCluster1, point1Id) {
        ...
        var atBottom = !displayCluster1._pointToNode[point1Id] || displayCluster1._state === States.Collapsed;
        if (!inZoomRange && !atBottom) {
            return displayCluster1._pointToNode[point1Id];
        }
    }
