        ...
        for (var sequence in connections) {
            ...
            for (var otherSequence in seqConnections) {
                ...
                if (!ids[connection.id]) {
                    ...
                    var displayCluster1 = connection.displayCluster1;
                    var displayCluster2 = connection.displayCluster2;

                    while ((!displayCluster1.isInZoomRange(zoom) || displayCluster1.state === States.Expanded) && displayCluster1.sequenceToChild[sequence1] && displayCluster1.state !== States.Collapsed) {
                        displayCluster1 = connection.displayCluster1 = displayCluster1.sequenceToChild[sequence1];
                    }

                    while ((!displayCluster2.isInZoomRange(zoom) || displayCluster2.state === States.Expanded) && displayCluster2.sequenceToChild[sequence2] && displayCluster2.state !== States.Collapsed) {
                        displayCluster2 = connection.displayCluster2 = displayCluster2.sequenceToChild[sequence2];
                    }
                }
            }
