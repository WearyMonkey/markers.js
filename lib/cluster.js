(function() {
    ...
    var Cluster = wm.Cluster = function (parent, zoom, zoomRange, geo, settings) {
        this._parent = parent;
    ...
    wmu.extend(Cluster, {
        ...
        makeRootCluster: function(geo) {
            return new Cluster(null, 0, MAX_ZOOM+1, geo, { zoomBoxes: getZoomBoxes(geo) } );
        }
    });
    ...
    function distancePointsSquared(self, p1, p2) {
        var latLng1 = p1._lat != null ? p1 : self._geo.getLatLng(p1);
        var latLng2 = p2._lat != null ? p2 : self._geo.getLatLng(p2);
