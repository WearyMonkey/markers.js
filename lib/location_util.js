(function() {
    ...
    var Markers = wm.Markers = function(map, options) {
        ...
        this._geo = options.mapConnector;
        this._clusterRoot = wm.Cluster.makeRootCluster(options.mapConnector);
    ...
    wmu.extend(Markers.prototype, {
        ...
        addPoints: function(points) {
            var wmPoints = [];
            for (var i = 0; i < points.length; ++i) wmPoints.push(wm.Point(points[i]));
